...
<?php
 function build_query($user_search, $sort) {
        ...
        // Ascending by maxCap
        case 5:
            $search_query .= " order by maxCapacity";
            break;
        // Descending by maxCap
        case 6:
            $search_query .= " order by maxCapacity DESC";
            break;
        default:
    ...
    function generate_page_links($user_search, $sort, $cur_page, $num_pages) {
        ...
        //Build table with toss to edit or remove
        while ($row = mysqli_fetch_array($result)) {
                ...
                echo '<td valign="top" width="20%"> <a href="editProgram.php?id=' . $row['Id'] . '">Edit</a></td>';
                echo '<td valign="top" width="15%"> <a href="removeProgram.php?id=' . $row['Id'] . '">Remove</a></td>';
                echo '</tr>';
        } 
